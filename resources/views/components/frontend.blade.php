...
<head>
    ...
    <!-- Favicons -->
    <link href="{{ url('public/frontend') }}/assets/img/logo-si.png" rel="icon">
    <link href="{{ url('public/frontend') }}/assets/img/logo-si.png" rel="apple-touch-icon">
    ...
    <link href="{{ url('public/frontend') }}/assets/vendor/fontawesome-free/css/all.min.css" rel="stylesheet">
